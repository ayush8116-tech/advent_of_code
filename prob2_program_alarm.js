...
const parameterChanger = (program, addressOneValue, addressTwoValue) => {
  const programToChange = program;

  programToChange[1] = addressOneValue;
...
const operator = (program, programInstructions, instruction) => {
  ...
  instructions[program[3]] = predicatesForProgram[instruction](
    programInstructions[program[1]],
    programInstructions[program[2]],
  );
